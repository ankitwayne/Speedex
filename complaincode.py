...
if n==1:
 print "<script>alert('Complain Successfully Submitted');window.location.href='index.py';</script>"
else:
 print "<script>alert('Not Submitted');window.location.href='index.py';</script>"